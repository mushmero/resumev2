...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form class="form" action="{{ route('proficiencylevel.store') }}" method="post">
                @csrf
                <x-adminlte-card title="{{ $table_title }}" theme="default" icon="fas fa-sm fa-wrench" collapsible>
                    <x-adminlte-input name="proficiency" label="Proficiency" fgroup-class="col-md-6 row" label-class="col-md-2 control-label" igroup-class="col-md-10" required enable-old-support/>
